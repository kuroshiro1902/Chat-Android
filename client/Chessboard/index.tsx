...
import { PlayerColor } from 'react-native-chessboard/src/types';
...
const Chessboard: React.FC<{playerColor?: PlayerColor}> = React.memo(({playerColor}) => {
  ...
  return (
    <ChessboardPropsContextProvider {...props}>
      <ChessboardContextProvider ref={chessboardRef} fen={props.fen}>
        <Chessboard playerColor={props.playerColor} />
